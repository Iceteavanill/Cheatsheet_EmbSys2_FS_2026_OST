...
% ========================================= DOCUMENT INFO =========================================
\def\title{Embedded Systems 2}                      % title
\def\shorttitle{EmbSys2}                            % short title (displayed as PDF title)
...
% Cache Colors
\newcommand{\cacheK}    {\pastelbox{cyan}   {\ensuremath{k}}}
\newcommand{\cacheI}    {\pastelbox{green}  {\ensuremath{i}}}
\newcommand{\cacheM}    {\pastelbox{orange}  {\ensuremath{m}}}


% =========================================== DOCUMENT ============================================
\begin{document}
    \begin{layout}
        \input{sections/01_RealTimeSystems.tex}
        \input{sections/02_ProcessesAndConcurrency.tex}
        \input{sections/03_EmbeddedMemory.tex}
        \input{sections/04_MemoryManagement.tex}
        \input{sections/05_Parallelism.tex}
        \input{sections/06_TinyML.tex}
        \input{sections/99_CodeBasics.tex}
    \end{layout}
\end{document}
