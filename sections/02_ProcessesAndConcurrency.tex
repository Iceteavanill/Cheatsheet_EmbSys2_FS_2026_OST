...
Inpterprocess communication is done via mutexes and semaphores.
...
\subsubsection{Synchronize tasks using a Mutex}
...
Using mutexes (or semaphores), tasks can be synchronized.
